...
class MemoryFileSystem:
    ...
    def __init__(self, save_path, event_bus: EventBus):
        self._event_bus = event_bus
        self.save_path = save_path

    def replace_path_with_symlink(self) -> bool:
    ...
    def destroy_ram_drive(self, ram_drive_letter=None) -> bool:
